...
<!-- navbar -->
      ...
      <div class="container">
    <a class="navbar-brand" href="index.html">PCTH</a>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="crud.html">Buat Data</a>
            <a class="dropdown-item" href="pengaturan.html">Pengaturan</a>
            <a class="dropdown-item" href="grafik.html">Grafik</a>
            <a class="dropdown-item" href="waktu.html">Waktu Panen</a>
  ...
  <!-- navbar -->
	...
	<section id="head" >
	  ...
	  <a class="btn btn-primary btn-lg" href="#" role="button">Uji Aplikasi</a>
	  </div>
	  </div>
	</div>
	</section>
		...
		<div class="row">
			...
			<div class="card mb-3" style="max-width: 540px;">
			  <div class="row no-gutters">
			    <div class="col-md-4">
			      <img src="gambar/user-1.jpg" class="card-img" alt="...">
			    </div>
			   	<div class="col-md-8">
			      <div class="card-body">
